...
public class MadeFood extends BaseBean implements Serializable {
    public MadeFood() {
        super();
    }
   ...
   public String getvRoleElse2() {
    ...
    private Integer iFoodId;
    public void setiFoodId(Integer iFoodId){
        this.iFoodId=iFoodId;
    }
   public Integer getiFoodId() {
        return iFoodId;
    }

    private String iFoodNum;
    public void setiFoodNum(String iFoodNum){
        this.iFoodNum=iFoodNum;
    }
   public String getiFoodNum() {
        return iFoodNum;
    }

    public MadeFood parseFromLogFile(String[] args, String GameId, String AccountType, String WorldId){
        return new MadeFood(GameId, AccountType, WorldId, args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8],args[9],args[10],args[11],args[12],args[13],args[14],args[15]);
    }

    public MadeFood(String GameId, String AccountType, String WorldId, String dtEventTime,String iEventId,String vVersionId,String vUin,String iRoleId,String vRoleName,String iRoleJob,String iRoleGender,String iRoleLevel,String iRoleVipLevel,String iRoleReputationLevel,String vRoleElse1,String vRoleElse2,String iFoodId,String iFoodNum){
        ...
        this.iFoodId = Integer.valueOf(iFoodId);
        this.iFoodNum = String.valueOf(iFoodNum);
    }
}
