...
public class Welfare extends BaseBean implements Serializable {
    public Welfare() {
        super();
    }
   ...
   public Integer getiWelfareWay() {
    ...
    private String jWelfareItems;
    public void setjWelfareItems(String jWelfareItems){
        this.jWelfareItems=jWelfareItems;
    }
   public String getjWelfareItems() {
        return jWelfareItems;
    }
   ...
   public String getvClientIP() {
    ...
    public Welfare parseFromLogFile(String[] args, String GameId, String AccountType, String WorldId){
        return new Welfare(GameId, AccountType, WorldId, args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8],args[9],args[10],args[11],args[12],args[13],args[14],args[15],args[16]);
    }

    public Welfare(String GameId, String AccountType, String WorldId, String dtEventTime,String iEventId,String vVersionId,String vUin,String iRoleId,String vRoleName,String iRoleJob,String iRoleGender,String iRoleLevel,String iRoleVipLevel,String iRoleReputationLevel,String vRoleElse1,String vRoleElse2,String iWelfareWay,String jWelfareItems,String vClientIP){
