...
public class CreateRole extends BaseBean implements Serializable {
    public CreateRole() {
        super();
    }
   ...
   public String getvLoginWay() {
    ...
    public CreateRole parseFromLogFile(String[] args, String GameId, String AccountType, String WorldId){
        return new CreateRole(GameId, AccountType, WorldId, args[1],args[2],args[3],args[4],args[5],args[6],args[7],args[8],args[9],args[10]);
    }

    public CreateRole(String GameId, String AccountType, String WorldId, String dtEventTime,String iEventId,String vVersionId,String vUin,String vClientIp,String iRoleId,String vRoleName,String iRoleJob,String iRoleGender,String vLoginWay){
